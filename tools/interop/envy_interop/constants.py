...
# Bootstrap is 0x01/0x09; HELLO is 0x11/0x19 (do not conflate).
KAD_OP_BOOTSTRAP_REQ = 0x01
KAD_OP_BOOTSTRAP_RES = 0x09
KAD_OP_HELLO_REQ = 0x11
KAD_OP_HELLO_RES = 0x19
KAD_OP_PING = 0x60
KAD_OP_PONG = 0x61
KAD_OP_FIND_NODE = 0x21  # KADEMLIA2_REQ
KAD_OP_FIND_NODE_RES = 0x29  # KADEMLIA2_RES
