...
PASS_CRITERIA: Dict[str, str] = {
    ...
    "kad_nodes_dat_local": "Local nodes.dat v1/v2/v3 parse/bootstrap preparation evidenced (fixture or log).",
    ...
    "kad_search_res": "SEARCH_RES (0x35) delivered into ED2K sources (not merely Kad process alive).",
