...
PASS_CRITERIA: Dict[str, str] = {
    ...
    "kad_hello": "Kad HELLO request + response evidence (opcodes 0x11 and 0x19).",
    "kad_ping_pong": "Kad PING + PONG evidence (opcodes 0x60 and 0x61).",
    "kad_find_node": "Kad FIND_NODE request + response evidence (opcodes 0x21 and 0x29).",
