...
**Version:** 1.0  
**Objectif:** Comparaison détaillée de l'implémentation ED2K/Kademlia d'Envy avec eMule (référence)
...
**Objectif:** Parité fonctionnelle avec eMule pour interopérabilité complète
...
- **Fichier à modifier:** `Envy/Kademlia.cpp` - Ajouter handlers
- **Complexité:** Faible (S)
...
- **Complexité:** Faible (S) - Corriger RNG et hash
...
- **Fichier à modifier:** `Envy/EDClient.cpp` - Ajouter handlers
- **Complexité:** Faible (S)
...
- **Fichier à modifier:** `Envy/UploadTransferED2K.cpp` - Ajouter compression
- **Complexité:** Moyenne (M)
...
**Fichier à modifier:**
- `Envy/Kademlia.h` - Ajouter timeouts spécifiques
- `Envy/Kademlia.cpp:772-783` - Implémenter retry logic
...
**Fichier à modifier:**
- `Envy/Kademlia.h` - Ajouter logique de splitting
- `Envy/Kademlia.cpp` - Implémenter `SplitBucket()`
...
**Fichier à modifier:**
- `Envy/Kademlia.cpp:44-62` - Implémenter LRU replacement
...
**Fichier à modifier:**
- `Envy/Kademlia.cpp:358-376` - Ajouter refresh dans `OnTimer()`
...
**Fichier à modifier:**
- `Envy/Kademlia.cpp:690-717` - Ajouter validation complète
...
**Fichier à modifier:**
- `Envy/Kademlia.cpp:690-717` - Ajouter vérification subnet
...
**Fichier à modifier:**
- `Envy/Kademlia.cpp` - Ajouter hole punching logic
...
**Fichier à modifier:**
- `Envy/Kademlia.cpp` - Ajouter firewall check
...
**Fichiers:**
- `Envy/Kademlia.cpp` - Ajouter handlers
- `Envy/Kademlia.h` - Ajouter constantes
...
**Fichiers:**
- `Envy/EDClient.cpp:64-159` - Corriger SecureID
- `Envy/EDClient.cpp` - Ajouter handlers
- `Envy/UploadTransferED2K.cpp` - Ajouter compression

**Tests:**
- Authentification SecureID fonctionnelle
...
**Fichiers:**
- `Envy/Kademlia.cpp` - Implémenter logiques
- `Envy/Kademlia.h` - Ajouter structures

**Tests:**
- Table de routage optimale
...
**Fichiers:**
- `Envy/Kademlia.cpp` - Ajouter validations
- `Envy/Kademlia.cpp` - Implémenter NAT traversal
