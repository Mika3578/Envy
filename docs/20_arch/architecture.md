...
**Cross-platform:** long-term target via `EnvyCore` + platform abstraction; Linux/macOS are **planned**, not supported. Canonical plan: [`PORTABILITY_PLAN.md`](PORTABILITY_PLAN.md). Root overview: `docs/ARCHITECTURE.md`.
