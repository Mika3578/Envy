...
- **ED2K SecureIdent:** eMule-compatible RSA SecureIdent is not implemented. As of #75 Envy does not advertise SecureIdent and never marks peers verified; inbound SecureIdent packets are ignored without blocking ED2K transfer. See `docs/DEVELOPMENT_PLAN.md` SecureIdent roadmap.
