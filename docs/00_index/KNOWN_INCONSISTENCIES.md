...
- **#90 / PR #243 crash reporter:** `develop` still ships BugTrap. PR #243 (closed, unmerged) implemented in-process `MiniDumpWriteDump`. D-017 records Crashpad as the capture engine; do not treat #243 as landed or as the long-term dumper. Canonical: `docs/10_dev/crash-reporting.md`.
