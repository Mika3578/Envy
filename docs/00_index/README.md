...
|---------|----------|-------|
| **User** | `docs/50_user/` | Guide, installation, configuration, [transfer settings](../50_user/transfer-settings.md), [settings reference](../50_user/reference/COMPLETE_SETTINGS_REFERENCE.md) |
| **Developer** | `docs/10_dev/` | Build, guide, standards, contributing, status, roadmap, [crash reporting](../10_dev/crash-reporting.md), [Crashpad vs Sentry Native](../10_dev/crashpad-vs-sentry-native.md) |
