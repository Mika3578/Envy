# Product roadmap sketch (historical archive, 2024–2025)

> **Historical snapshot only.** Do not treat checkboxes below as current protocol or product completeness.
> Canonical sources: [`docs/DEVELOPMENT_PLAN.md`](../../DEVELOPMENT_PLAN.md), [`docs/10_dev/roadmap.md`](../roadmap.md), [`docs/10_dev/status.md`](../status.md), [`docs/30_protocols/REFERENCE_IMPLEMENTATIONS.md`](../../30_protocols/REFERENCE_IMPLEMENTATIONS.md).
>
> In particular, IPv6 remains **partial** (dual-stack integration still incomplete); see `docs/10_dev/status.md`.
