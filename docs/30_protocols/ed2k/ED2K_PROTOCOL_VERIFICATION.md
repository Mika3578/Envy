...
- ✅ **nodes.dat Import:** Legacy v0 + new-format v1/v2/v3 (`KadNodesDat.h` / `HostCache::ImportNodes`). v3 bootstrap edition is bounded. UDP-key runtime protocol is not implemented. Remote HTTP download is not wired (`docs/10_dev/status.md`).
