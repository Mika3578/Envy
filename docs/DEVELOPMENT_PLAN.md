...
- **Changelog Entry:** 2026-09-18 — #81: BitTorrent TCP length-prefix capped at 16 MiB (`BtPacketLengthOk`); oversize clears input and closes peer (`IDS_PROTOCOL_TOO_LARGE`).
