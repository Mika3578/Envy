...
- **Changelog Entry:** 2026-09-22 — PR Gate rerun ordering split from #303: select the latest check run by timestamp with id tie-breaker so old failures do not mask successful reruns and old successes do not mask newer pending/failing reruns.
