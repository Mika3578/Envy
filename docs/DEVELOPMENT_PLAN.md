...
- **Changelog Entry:** 2026-09-19 — #90: `CopyCrashpadHandler.cmd` copies the configuration-matching vcpkg handler (`tools/crashpad` for Release, `debug/tools/crashpad` for Debug) instead of the first recursive `dir /s /b` hit.
