...
- **Changelog Entry:** 2026-09-18 — #81: G2 HIT_WRAP / wrapped G1 `m_nLength` fail-closed (`G1WrappedPayloadFits` / `G1WrappedPayloadLengthOk`) before unsigned math and Write.
