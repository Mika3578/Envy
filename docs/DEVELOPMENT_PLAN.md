...
- **Changelog Entry:** 2026-09-19 — Cloud Agent Linux env: add `.cursor/environment.json` installing clang-format/clang-tidy/cppcheck + `Remote/tests` npm deps for ubuntu-style checks (MFC/HashLib remain Windows-only).
