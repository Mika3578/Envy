...
- **Changelog Entry:** 2026-09-21 — Repository tree hygiene inventory (synced after #299): 3344 files / 164 dirs; no mass moves; canonical docs map + roadmap Current State dedupe. Next independent PRs: `.gitignore`, unused `.vcproj` (keep PluginWizard), then duplicates/vcpkg. See `docs/10_dev/repository-tree-hygiene.md`.
