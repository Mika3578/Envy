...
- [x] Removed `register` keyword (`Envy/Buffer.cpp`, `HashLib/TigerTree.cpp`, `Envy/Strings.cpp`) - reserved in C++17 / C5033; remaining first-party uses are tracked under #84
