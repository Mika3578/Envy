...
protected:
	...
	BOOL OnPacket_KADEMLIA2_REQ(const SOCKADDR_IN* pHost, CEDPacket* pPacket);
	BOOL OnPacket_KADEMLIA2_RES(const SOCKADDR_IN* pHost, CEDPacket* pPacket);
	BOOL OnPacket_KADEMLIA2_SEARCH_KEY_REQ(const SOCKADDR_IN* pHost, CEDPacket* pPacket);
	BOOL OnPacket_KADEMLIA2_SEARCH_SOURCE_REQ(const SOCKADDR_IN* pHost, CEDPacket* pPacket);
	BOOL OnPacket_KADEMLIA2_SEARCH_NOTES_REQ(const SOCKADDR_IN* pHost, CEDPacket* pPacket);
	BOOL OnPacket_KADEMLIA2_PUBLISH_KEY_REQ(const SOCKADDR_IN* pHost, CEDPacket* pPacket);
	BOOL OnPacket_KADEMLIA2_PUBLISH_SOURCE_REQ(const SOCKADDR_IN* pHost, CEDPacket* pPacket);
	BOOL OnPacket_KADEMLIA2_PUBLISH_NOTES_REQ(const SOCKADDR_IN* pHost, CEDPacket* pPacket);
	BOOL OnPacket_KADEMLIA2_PUBLISH_RES(const SOCKADDR_IN* pHost, CEDPacket* pPacket);
	BOOL OnPacket_KADEMLIA_FIREWALLED_REQ(const SOCKADDR_IN* pHost, CEDPacket* pPacket);
	BOOL OnPacket_KADEMLIA_FIREWALLED_RES(const SOCKADDR_IN* pHost, CEDPacket* pPacket);
	BOOL OnPacket_KADEMLIA_FIREWALLED_ACK_RES(const SOCKADDR_IN* pHost, CEDPacket* pPacket);
	BOOL OnPacket_KADEMLIA_FINDBUDDY_REQ(const SOCKADDR_IN* pHost, CEDPacket* pPacket);
	BOOL OnPacket_KADEMLIA_FINDBUDDY_RES(const SOCKADDR_IN* pHost, CEDPacket* pPacket);
