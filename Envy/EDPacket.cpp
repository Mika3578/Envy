...
public:
	inline CEDPacketTypes() throw()
	{
		...
		// eMule Client - Client, TCP
			...
			{ ED2K_C2C_PUBLICIP_REQ,		ED2K_PROTOCOL_EMULE,	FALSE,	FALSE,	L"PublicIPReq" },
			{ ED2K_C2C_PUBLICIP_ANSWER,		ED2K_PROTOCOL_EMULE,	FALSE,	FALSE,	L"PublicIPAnswer" },
			{ ED2K_C2C_CALLBACK,			ED2K_PROTOCOL_EMULE,	FALSE,	FALSE,	L"Callback" },
			{ ED2K_C2C_REASKCALLBACKTCP,	ED2K_PROTOCOL_EMULE,	FALSE,	FALSE,	L"ReaskCallbackTCP" },
				...
				if ( m_nLength >= 2 )
				{
					try
					{
						...
						if ( nMsgLen > 0 && nMsgLen <= m_nLength - 2 )
						{
							...
							if ( strMessage.IsEmpty() || strMessage.Find( L'�' ) != -1 )
							{
