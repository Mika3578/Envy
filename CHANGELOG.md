...
- **Network async job queue cap (#81)** — `CNetwork::m_oJobs` drops oldest owned search/hit trees once depth reaches 2048 (`NETWORK_JOB_QUEUE_MAX` / `EnqueueJob`), closing the long-standing overload-protection TODO under query floods.
