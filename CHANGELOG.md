...
### Fixed
- **ED2K chat MESSAGE length predicate (#81)** — `CEDClient::OnChatMessage` uses shared `Ed2kChatMessageLengthOk` (non-empty, `<= ED2K_CHAT_MESSAGE_MAX` / `ED2K_MESSAGE_MAX`, exact remaining fit) with EnvyTests smoke coverage.
