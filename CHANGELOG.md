...
### Fixed
- **ED2K chat MESSAGE length predicate (#81)** — `OnChatMessage` validates via shared `Ed2kChatMessageLengthOk` (non-empty, ≤500, exact remaining fit) with EnvyTests smoke coverage. Behavior unchanged vs prior inline checks.
