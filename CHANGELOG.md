...
### Added
- **Transfer settings limit helpers** — `Envy/TransferSettingsLimits.h` plus EnvyTests (`test_transfer_settings_limits_smoke.cpp`) for unlimited bandwidth tokens, DWORD overflow clamp, and `MaxPerHost` range. See `docs/50_user/transfer-settings.md`.
