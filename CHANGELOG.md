...
### Fixed
- **BitTorrent MSE Pad_C/Pad_D receive cap (#81)** — Reject peer-advertised pad lengths above 512 (`BtMsePadLengthOk` / `BT_MSE_PAD_MAX`, matching send-side `MSE_PAD_MAX_LEN`) before `new[]`/wait-for-bytes during MSE handshake.
