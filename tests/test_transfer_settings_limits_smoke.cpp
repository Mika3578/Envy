...
// conversion, MaxPerHost clamp, Fair-Use unimplemented flag, and absent-key
...
static bool test_fair_use_not_implemented()
{
	return TransferFairUseModeImplemented() == false
...
void register_transfer_settings_limits_smoke_tests(TestSuite& suite)
{
	...
	suite.add_test( "transfer_fair_use_not_implemented",
		test_fair_use_not_implemented );
